...
<body class="dark:bg-mainColorDark bg-slate-50">
  ...
  <main class="profile-page">
    ...
    <section>
      <form action="" method="POST" class="w-[50%] h-[50%]">
        <div>
          <div>
                ...
                <div
                  ...
                  <div class="modal-content py-4 text-left px-6">
                    ...
                    <div class="flex justify-between items-center pb-3">
                      ...
                      <div class="modal-close cursor-pointer z-100">
                    ...
                    <label for="Title" class="text-gray-800 text-sm font-bold">Title</label>
                    <input id="Title" name="Title"
                      class="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"
                      placeholder="Ex: logo design..." />
                    <label for="Amount"
                      class="text-gray-800 text-sm font-bold leading-tight tracking-normal">Amount</label>
                    <input id="Amount" name="Amount"
                      class="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"
                      placeholder="" />
                    <label for="Deadline" class="text-gray-800 text-sm font-bold leading-tight tracking-normal">Deadline</label>
                    <input id="password" name="Deadline"
                      class="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border"
                      placeholder="Ex: Delivery in 1 day" />
...
<script src="https://cdn.tiny.cloud/1/rc42racaernzwkvx6bn5it5s2fu73in8n0swr1xqfp2h81c5/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
