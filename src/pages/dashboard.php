...
<body class="font-poppins dark:bg-gray-900 text-mainBlue dark:text-white">
    <section class="flex flex-row">
        ...
        <main style="width: 100%;" class="bg-white dark:bg-gray-900">
                            ...
                            <div
                                ...
                                <div class="modal-content py-4 text-left px-6">
                                    ...
                                    <div class="flex justify-between items-center pb-3">
                                        <p class="text-2xl text-center text-mainBlue font-bold">Edit Your Information
                                        </p>
            ...
            <div class=" text-black dark:text-white dark:bg-indigo-950 p-4  m-[2%] rounded-2xl border dark:border-none">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">Ann</td>
                            <td class="px-6 py-4 whitespace-nowrap">casablanca</td>
                            <td class="px-6 py-4 whitespace-nowrap">Settet</td>
                            ...
                            <td class="flex flex-row px-6 py-4 whitespace-nowrap">
                                <div>
                                    <div>
                                        <button
                                            class="modal-open ml-2 px-4 py-2 font-medium text-white bg-green-600 rounded-md hover:bg-green-700 focus:outline-none focus:shadow-outline-red active:bg-green-600 transition duration-150 ease-in-out">Edit</button>
                                    </div>

                                </div>
                                <div>
                                    <button
                                        class="ml-2 px-4 py-2 font-medium text-white bg-red-400 rounded-md hover:bg-red-500 focus:outline-none focus:shadow-outline-red active:bg-red-700 transition duration-150 ease-in-out">Delete</button>
                                </div>
                            </td>
                        </tr>
                    </tbody>
